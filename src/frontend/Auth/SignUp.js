            ...
            <div className="flex flex-col items-center space-y-5">
              <div className="flex flex-col items-start w-full max-w-lg">
                <label
                  htmlFor="email"
                  required
                  className="mb-2 text-base text-black font-semibold"
                >
                  Email
                </label>
                <input
              ...
              <button
                className="h-12 w-full max-w-lg rounded-lg border-0 bg-purple-800 font-bold text-white cursor-pointer font-oswald mt-3 hover:bg-green-600 transition-colors duration-500"
                type="submit"
              >
